...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  ...
  <main class="px-3">
    <h1>Projet 3 : API REST</h1>
    <p class="lead">Vous venez d’être recruté comme développeur par Philippe - directeur d’une toute nouvelle
...
mises à disposition.</p>
  ...
  <footer class="mt-auto text-black-50">
    <p>Currency converter front , by <a href="https://getbootstrap.com/" class="text-black"> Sébastian and Bootstrap</a></p>
  </footer>
</div>
